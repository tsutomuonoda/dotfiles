;;; init-colorthemes.el --- colorthemes Conf
  ...
  (color-theme-install
   '(color-theme-inkpot
     ((foreground-color . "#cfbfad")
      ...
      (border-color . "#3e3e5e")
      (cursor-color . "#ff66ff") ; original inkpot: #404040
     ...
     (modeline ((t (:bold t :foreground "#b9b9b9" :background "#3e3e5e")))) ;:original foreground "#b9b9b9
...
(eval-after-load "color-theme"
  '(progn
     (color-theme-initialize)
					;(color-theme-jsc-dark)3
					;          (color-theme-dark-laptop)3
;     (color-theme-ld-dark)2
;     (color-theme-tty-dark)2
                         (color-theme-inkpot)
